...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint",help="the dir to checkpoint which the model read from", default='test/tmp/results_nusc.json'
    )
    parser.add_argument("--hungarian", action='store_true')
    parser.add_argument("--data_root", type=str, default='/home/eddy/Programs/StreamPETR/data/nuscenes')
    parser.add_argument("--version", type=str, default='v1.0-mini')
    parser.add_argument("--max_age", type=int, default=3)
    parser.add_argument("--score_threshold", type=int, default=0.25)
    parser.add_argument("--json_savepath", type=str, default='./')
...
def main():
    ...
    with open(os.path.join(args.json_savepath, 'tracking_result.json'), "w") as f:
        json.dump(nusc_annos, f)
    return speed
