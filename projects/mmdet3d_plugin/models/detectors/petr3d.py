...
def vis_gt(gt_bboxes_3d, gt_labels_3d):
...
class Petr3D(MVXTwoStageDetector):
    ...
    def obtain_history_memory(self,
        ...
        for i in range(T):
            ...
            for key in data:
                if key in ['gt_bboxes_3d_vec', 'gt_labels_3d_vec']:
                    data_t[key] = data[key]
                else:
    ...
    def forward_train(self,
        ...
        gt_seg_masks = data.pop('gt_seg_mask')
        gt_pv_seg_masks = data.pop('gt_pv_seg_mask')
