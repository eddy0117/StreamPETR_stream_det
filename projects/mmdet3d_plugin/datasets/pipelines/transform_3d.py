...
class PadMultiViewImage():
    ...
    def __call__(self, results):
        ...
        """
        # MODIFIED
        # print("This is PadMultiViewImage")
...
class NormalizeMultiviewImage(object):
    ...
    def __call__(self, results):
        ...
        """
        # MODIFIED
        # print("This is NormalizeMultiviewImage")
        # print('mean:', self.mean, 'std:', self.std, 'to_rgb:', self.to_rgb)
...
class ResizeCropFlipRotImage():
    ...
    def __call__(self, results):
        # MODIFIED
        # print("This is ResizeCropFlipRotImage")
        imgs = results['img']
        N = len(imgs)
        new_imgs = []
        new_gt_bboxes = []
